...
2.1.2: use the Keychain class (preferred)

create a keychain instance that will give you ways to load/add/find credentials from your .mongopw file:
...
kc$findKey(host,db)
kc$getCredentials(db_host, db_name)
kc$addKey(host, db, user, passwd, authSource = NULL, authMechanism = NULL)

and function: addKeychainEntry(host = NULL,
  db = NULL,
  user = NULL,
  passwd = NULL,
  authSource = NULL,
